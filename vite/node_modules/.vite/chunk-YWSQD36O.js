...
var lower16, factor16, MapResult, StepMap, Mapping, Transform, prototypeAccessors, stepsByID, Step, StepResult, ReplaceStep, ReplaceAroundStep, AddMarkStep, RemoveMarkStep, Fitter, prototypeAccessors$1;
var init_index_es2 = __esm({
  "../node_modules/prosemirror-transform/dist/index.es.js"() {
    ...
    StepMap.prototype._map = function _map(pos, assoc, simple) {
      ...
      for (var i = 0; i < this.ranges.length; i += 3) {
        ...
        if (pos <= end) {
          ...
          var recover2 = makeRecover(i / 3, pos - start);
    ...
    Mapping = function Mapping2(maps, mirror, from, to) {
      this.maps = maps || [];
      this.from = from || 0;
    ...
    Mapping.prototype._map = function _map2(pos, assoc, simple) {
      ...
      for (var i = this.from; i < this.to; i++) {
        var map4 = this.maps[i], rec = recoverables && recoverables[i];
        if (rec != null && map4.touches(pos, rec)) {
          pos = map4.recover(rec);
          continue;
        }
        var result = map4.mapResult(pos, assoc);
    ...
    Transform = function Transform2(doc) {
      this.doc = doc;
      this.steps = [];
      this.docs = [];
      this.mapping = new Mapping();
    };
    prototypeAccessors = { before: { configurable: true }, docChanged: { configurable: true } };
    ...
    StepResult = function StepResult2(doc, failed) {
      this.doc = doc;
      this.failed = failed;
    };
    ...
    AddMarkStep = function(Step3) {
      ...
      AddMarkStep2.prototype.apply = function apply2(doc) {
        ...
        var slice2 = new Slice(mapFragment(oldSlice.content, function(node, parent2) {
          if (!parent2.type.allowsMarkType(this$1.mark.type)) {
            return node;
          }
    ...
    Fitter = function Fitter2($from, $to, slice2) {
      this.$to = $to;
      this.$from = $from;
    ...
    prototypeAccessors$1 = { depth: { configurable: true } };
    ...
    Fitter.prototype.findCloseLevel = function findCloseLevel($to) {
      scan:
        for (var i = Math.min(this.depth, $to.depth); i >= 0; i--) {
          ...
          var match = ref.match;
          var type = ref.type;
          var fit2 = contentAfterFits($to, i, type, match, false);
          if (!fit2) {
            continue;
          }
          for (var d = i - 1; d >= 0; d--) {
...
//# sourceMappingURL=chunk-YWSQD36O.js.map
