...
var classesById, Selection, prototypeAccessors, SelectionRange, TextSelection, TextBookmark, NodeSelection, NodeBookmark, AllSelection, AllBookmark, UPDATED_SEL, UPDATED_MARKS, UPDATED_SCROLL, Transaction, FieldDesc, baseFields, Configuration, EditorState, prototypeAccessors$1, applyListeners, Plugin, keys, PluginKey;
var init_index_es3 = __esm({
  "../node_modules/prosemirror-state/dist/index.es.js"() {
    ...
    prototypeAccessors = { anchor: { configurable: true }, head: { configurable: true }, from: { configurable: true }, to: { configurable: true }, $from: { configurable: true }, $to: { configurable: true }, empty: { configurable: true } };
    ...
    UPDATED_MARKS = 2;
    UPDATED_SCROLL = 4;
    Transaction = function(Transform2) {
    ...
    FieldDesc = function FieldDesc2(name, desc, self) {
      this.name = name;
    ...
    prototypeAccessors$1 = { schema: { configurable: true }, plugins: { configurable: true }, tr: { configurable: true } };
...
//# sourceMappingURL=chunk-37MHF4IQ.js.map
