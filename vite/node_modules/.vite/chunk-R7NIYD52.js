...
var orderedmap, index_es_default;
...
var Fragment, prototypeAccessors, found, Mark, Slice, prototypeAccessors$1, ResolvedPos, prototypeAccessors$2, resolveCache, resolveCachePos, resolveCacheSize, NodeRange, prototypeAccessors$1$1, emptyAttrs, Node, prototypeAccessors$3, TextNode, ContentMatch, prototypeAccessors$4, TokenStream, prototypeAccessors$1$2, NodeType, prototypeAccessors$5, Attribute, prototypeAccessors$1$3, MarkType, Schema, DOMParser, blockTags, ignoreTags, listTags, OPT_PRESERVE_WS, OPT_PRESERVE_WS_FULL, OPT_OPEN_LEFT, NodeContext, ParseContext, prototypeAccessors$6, DOMSerializer;
var init_index_es2 = __esm({
  "../node_modules/prosemirror-model/dist/index.es.js"() {
    init_index_es();
    Fragment = function Fragment2(content, size) {
      this.content = content;
      this.size = size || 0;
      if (size == null) {
    ...
    Slice = function Slice2(content, openStart, openEnd) {
      this.content = content;
    ...
    Node = function Node2(type, attrs, content, marks2) {
      this.type = type;
      this.attrs = attrs;
    ...
    DOMSerializer.prototype.serializeFragment = function serializeFragment(fragment, options, target) {
      ...
      fragment.forEach(function(node3) {
        ...
        top.appendChild(this$1.serializeNode(node3, options));
      });
      return target;
    };
    ...
    DOMSerializer.prototype.serializeNodeAndMarks = function serializeNodeAndMarks(node3, options) {
      if (options === void 0)
        options = {};
      var dom = this.serializeNode(node3, options);
...
//# sourceMappingURL=chunk-R7NIYD52.js.map
