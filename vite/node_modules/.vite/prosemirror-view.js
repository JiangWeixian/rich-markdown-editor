...
var nothing = [];
var WidgetViewDesc = function(ViewDesc3) {
...
var CompositionViewDesc = function(ViewDesc3) {
...
var MarkViewDesc = function(ViewDesc3) {
...
var NodeViewDesc = function(ViewDesc3) {
...
var BRHackViewDesc = function(ViewDesc3) {
...
ViewTreeUpdater.prototype.findNodeMatch = function findNodeMatch(node2, outerDeco, innerDeco, index) {
  var found = -1, preMatch2 = index < 0 ? void 0 : this.getPreMatch(index), children = this.top.children;
  if (preMatch2 && preMatch2.matchesNode(node2, outerDeco, innerDeco)) {
    found = children.indexOf(preMatch2);
  } else {
    for (var i = this.index, e = Math.min(children.length, i + 5); i < e; i++) {
      var child = children[i];
      if (child.matchesNode(node2, outerDeco, innerDeco) && this.preMatched.indexOf(child) < 0) {
        found = i;
        break;
      }
    }
...
ViewTreeUpdater.prototype.updateNextNode = function updateNextNode(node2, outerDeco, innerDeco, view, index) {
  for (var i = this.index; i < this.top.children.length; i++) {
    ...
    if (next instanceof NodeViewDesc) {
      var preMatch2 = this.preMatched.indexOf(next);
      if (preMatch2 > -1 && preMatch2 + this.preMatchOffset != index) {
        return false;
      }
...
function preMatch(frag, descs) {
  var result2 = [], end = frag.childCount;
  for (var i = descs.length - 1; end > 0 && i >= 0; i--) {
    var desc = descs[i], node2 = desc.node;
    if (!node2) {
      continue;
    }
    if (node2 != frag.child(end - 1)) {
      break;
    }
    result2.push(desc);
    --end;
  }
  return { nodes: result2.reverse(), offset: end };
}
...
export {
  ...
  DecorationSet,
  EditorView,
  endComposition as __endComposition,
  parseFromClipboard as __parseFromClipboard,
  serializeForClipboard as __serializeForClipboard
};
//# sourceMappingURL=prosemirror-view.js.map
