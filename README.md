[![npm version](https://badge.fury.io/js/@jiangweixian1994%2Frich-markdown-editor.svg)](https://badge.fury.io/js/rich-markdown-editor)
# rich-markdown-editor

> **💡 NOTE**  
This project is **unofficial version of [rich-markdown-editor](https://github.com/outline/rich-markdown-editor)**. but with extra some features not merged into [rich-markdown-editor](https://github.com/outline/rich-markdown-editor) yet

|feature|snapshot|
|:---:|:---:|
|merge / split cell|![color](./docs/snapshot/merge.gif)|
|advanced highlight|![color](./docs/snapshot/color.gif)|
|stick toolbar|![stick-toolbar](./docs/snapshot/stick-toolbar.png)|
...
```bash
yarn add @jiangweixian1994/rich-markdown-editor
```

or

```bash
npm install @jiangweixian1994/rich-markdown-editor
```
...
```javascript
import Editor from "@jiangweixian1994/rich-markdown-editor";
